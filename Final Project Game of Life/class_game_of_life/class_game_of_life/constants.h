...
const int size=/*100; 40*/100; //change size of array
const double cell_lengh=/*8; 20*/8; // change the size of each cell & the size of buttons
const double outline=/*1; 2*/1; //change the distance between two cells
const int CEW=4; // change the how many cell the button equal

//User can not change:
const int button_x=(size+outline)*cell_lengh;
